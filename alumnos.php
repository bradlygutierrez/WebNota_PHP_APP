...
<body>
    ...
    $query = "INSERT INTO alumnos (No_Carnet, Nombre_Completo, Cedula, Direccion, Telefono, Carrera, Turno, Cursa, Activo) 
              VALUES ('$No_Carnet', '$Nombre_Completo', '$Cedula', '$Direccion', '$Telefono', '$Carrera', '$Turno', '$Cursa', '$Activo')";
